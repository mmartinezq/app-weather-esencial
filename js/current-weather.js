...
import {weatherCoditionsCode} from "./constants.js";
...
function solarStatus(sunsetTime,sunriseTime){
    ...
    const sunrisetHours = sunriseTime.getHours();
        if (currentHours>sunsetHours ||currentHours<sunrisetHours) {
            return "night";
        }
    return "morning";
}
function setBackground(el,conditionCode,solarStatus){
    const weatherType = weatherCoditionsCode[conditionCode];
